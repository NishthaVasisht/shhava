...
export default function Home() {
  ...
  useEffect(() => {
    ...
    link.href =
      'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700&family=Noto+Sans+Devanagari:wght@300;400;500;600&family=Inter:wght@300;400;500;600;700&family=Fredoka:wght@300;400;500;600;700&display=swap';
    link.rel = 'stylesheet';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav
        className={`relative z-10 flex flex-col sm:flex-row justify-between items-center p-4 sm:p-6 md:p-8 transition-all duration-1000 ${
      ...
      >
        <div className="flex items-center space-x-3 mb-4 sm:mb-0">
          <div className="w-10 h-10 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justify-center shadow-lg hover-glow animate-neon-glow">
            <img src="./public/logo.png" alt="icon" className="w-6 h-6 object-contain" />
          </div>
      ...
      <section className="relative z-10 text-center px-4 sm:px-6 pt-8 sm:pt-12 md:pt-20">
        <div className="max-w-4xl mx-auto">
          <h1
            className={`text-4xl sm:text-5xl md:text-7xl font-bold mb-6 sm:mb-8 leading-tight transition-all duration-1000 ${
          ...
          <p
            className={`text-lg sm:text-xl md:text-2xl text-gray-700 mb-4 leading-relaxed max-w-3xl mx-auto transition-all duration-1000 delay-300 ${
              isVisible ? 'animate-slide-in-up' : 'opacity-0'
            }`}
          ...
          <p
            className={`text-base sm:text-lg text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto transition-all duration-1000 delay-400 ${
              isVisible ? 'animate-slide-in-up' : 'opacity-0'
            }`}
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
          ...
          <div
            className={`flex flex-col gap-4 justify-center items-center mb-12 sm:mb-16 transition-all duration-1000 delay-500 ${
              isVisible ? 'animate-slide-in-up' : 'opacity-0'
            }`}
          >
          ...
          {/* Features Section */}
          <div
            className={`bg-white/80 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl max-w-5xl mx-auto hover-lift transition-all duration-1000 delay-600 ${
              isVisible ? 'animate-slide-in-up' : 'opacity-0'
            }`}
          >
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
              <div className="text-left">
                <div className="flex items-center space-x-3 mb-4 sm:mb-6 animate-slide-in-left">
                  ...
                  <h3
                    className="text-xl sm:text-2xl font-bold text-gray-800 animate-fade-in"
                    style={{ fontFamily: 'Fredoka, sans-serif' }}
                  >
              ...
              <div className="relative animate-slide-in-right delay-200">
                <div className="w-64 sm:w-80 h-64 sm:h-80 mx-auto bg-gradient-to-br from-purple-100 to-pink-100 rounded-3xl flex items-center justify-center shadow-xl hover-glow transition-all duration-500">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 animate-shimmer" style={{ fontFamily: 'Fredoka, sans-serif' }}>
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-r from-purple-50 to-pink-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2
            className="text-3xl sm:text-4xl font-bold mb-4 animate-slide-in-up"
            style={{ fontFamily: 'Fredoka, sans-serif' }}
          >
          ...
          <p className="text-lg sm:text-xl text-gray-700 mb-8 sm:mb-12 leading-relaxed animate-slide-in-up delay-200">
            With real-ID verification, Creep Detector AI, and friend check-ins that would make Monica proud of our organization skills! 📋✨
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={index}
                className={`flex items-center space-x-3 p-4 bg-white/70 rounded-xl hover-lift animate-slide-in-left delay-${
                  (index + 1) * 100
                }`}
              >
      ...
      <footer className="relative z-10 py-12 sm:py-16 md:py-20 px-4 sm:px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2
            className="text-2xl sm:text-3xl font-bold mb-4 animate-slide-in-up"
            style={{ fontFamily: 'Fredoka, sans-serif' }}
          >
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient-shift">
          ...
          <p
            className="text-base sm:text-lg text-gray-600 mb-2 animate-slide-in-up delay-100"
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            <strong>"It's gonna be legend... wait for it..."</strong>
          </p>
          <p
            className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 animate-slide-in-up delay-200"
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
          ...
          <p
            className="text-xs sm:text-sm text-gray-500 mt-4 sm:mt-6 animate-fade-in delay-500"
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            Starting where the magic happens • Expanding faster than Phoebe's song catalog • Built with 💜 for those who
            deserve their own sitcom ending
          </p>
        </div>
      </footer>
    </div>
